      ...
      <div className={styles.arrowR1Wrapper}>
        <div className={styles.arrowR1}>
          <img
            ...
            src={
              yellow
                ? process.env.PUBLIC_URL + '/img/arrows/arrow-right-yellow.png'
                : process.env.PUBLIC_URL + '/img/arrows/arrow-right.png'
            }
          />
        </div>
      </div>
      ...
      <div className={yellow ? styles.arrowD1WrapperYellow : styles.arrowD1Wrapper}>
        <div className={yellow ? styles.arrowD1Yellow : styles.arrowD1}>
          <img
            alt=''
            src={
              yellow ? process.env.PUBLIC_URL + '/img/arrows/arrow-down-yellow.png' : process.env.PUBLIC_URL + '/img/arrows/arrow-down.png'
            }
          />
        </div>
      </div>
        ...
        <div className={styles.arrowR1D1rightWrapper}>
          <div className={styles.arrowR1D1right}>
            <img
              ...
              src={
                yellow
                  ? process.env.PUBLIC_URL + '/img/arrows/arrow-right-down-yellow.png'
                  : process.env.PUBLIC_URL + '/img/arrows/arrow-right-down.png'
              }
            />
          </div>
        </div>
        <div className={yellow ? styles.arrowR1D1downWrapperYellow : styles.arrowR1D1downWrapper}>
          <div className={yellow ? styles.arrowR1D1downYellow : styles.arrowR1D1down}>
            <img
              ...
              src={
                yellow
                  ? process.env.PUBLIC_URL + '/img/arrows/arrow-down-yellow.png'
                  : process.env.PUBLIC_URL + '/img/arrows/arrow-down.png'
              }
            />
          </div>
        </div>
