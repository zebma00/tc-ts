...
=======
	...
	note: 'Note',
	content: [
		'Vendors have been added for all capital city factions. These vendors sell various items, recipes and enchants in exchange for Badges of Justice. Many of these items and enchants require specific reputation.',
		'Capital city reputation can be gained by turning in resources like copper ore, silk cloth, arcane dust, thick leather, et cetera. Turning in these resources rewards no more reputation after Honored.',
		"Players can also earn reputation with capital cities by wearing the city's tabard while doing various PvE activities.",
		'Reputation gained from leveling quests has been adjusted.',
		'Battleground faction vendors now sell additional equipment, in exchange for Marks of Honor in addition to gold.',
		'Players can earn additional reputation with battleground factions by wearing the faction’s tabard while doing various PvP activities.',
	],
>>>>>>> 1ddb4f1 (patch notes)
}
