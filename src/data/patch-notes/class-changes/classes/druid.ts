export default {
  ...
  content: [
    ...
    'Barkskin now reduces all damage taken by 20%, no longer reduces cast time and attack speed, and can be cast while frozen, incapacitated or feared. Cooldown is increased to 3 min.',
