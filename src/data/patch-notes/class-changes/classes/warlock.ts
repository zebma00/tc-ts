export default {
  ...
  content: [
    ...
    'Firestone reworked: Bonus fire spell damage increased. No longer in grants attacks a chance to deal fire damage. Instead Firestone removes the additional threat caused by Searing Pain.',
    'Spellstone now increases spell critical strike chance by 2% and spell hit chance by 2%.',
    'Demon armor now restores 1% of the warlock’s health every 3 seconds instead of a flat amount.',
