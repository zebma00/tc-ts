export default {
  ...
  content: [
    ...
    'All Shamans now gain the ability to wield Two-Handed Axes and Maces. Learned at level 20.',
    'All Shamans now gain the ability to parry melee attacks. Learned at level 30.',
