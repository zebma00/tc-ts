export default {
  ...
  content: [
    ...
    "Feedback (Human) significantly reduced mana cost. Feedback now also grants the priest 5% damage reduction for 10 min of the attacker's used spell school. 1 min cooldown.",
    ...
    'Starshards (Night Elf) now deals increased damage, slows the target by 50% and lasts 4 sec. 1 min cooldown.',
    'Shadowguard (Troll) now deals slightly increased damage.',
    'Touch of Weakness (Undead) effect now stacks up to 3 times but lasts only 30 sec.',
