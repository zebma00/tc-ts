...
export default [
	...
	new Item('Band of Guidance', 'inv_jewelry_ring_43', 'epic', 'Finger', null, null, null, null, null, [
	...
	new Item('Idol of the World Tree', 'inv_qirajidol_night', 'epic', 'Relic', 'Idol', null, null, null, null, [
		'When you cast Innervate on a friendly target, you gain Innervate as well, but reduces the duration of your Innervate by 50%.',
	]),
	new Item('Jewel of Synergy', 'inv_jewelry_ring_64', 'epic', 'Trinket', null, null, null, null, null, [
		'Increases your damage by 10% for 8 sec after dealing damage from three different magic schools within 5 sec.',
	]),
	new Item('Book of Command', 'warlock_grimoireofcommand', 'epic', 'Trinket', null, null, null, null, null, [
		'Use: Increases the damage and critical strike chance of your active pets and summons by 10% for 15 sec. (3min cooldown)',
	]),
	new Item('Totem of Tidal Orbs', 'inv_qirajidol_life', 'epic', 'Relic', 'Totem', null, null, null, null, [
		'Damage from your Lightning Shield returns mana equal to 60% of the damage dealt.',
	]),
	new Item(
