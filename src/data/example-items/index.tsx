...
export default [
  new Item('Libram of Wrath', 'inv_misc_book_07', 'epic', 'Relic', 'Libram', null, null, null, null, ['Allows your Hammer of Wrath to be cast on targets with any amount of health, but reduces the damage by 95%.']),
  ...
  new Item('Band of Guidance', 'inv_jewelry_ring_43', 'epic', 'Finger', null, null, null, null, null, ['Equip: Increases your chance to hit by 2%.', 'Equip: Increases your chance to hit with spells by 2%.']),
  ...
  new Item('Idol of the World Tree', 'inv_qirajidol_night', 'epic', 'Relic', 'Idol', null, null, null, null, ['Increases the duration of your Rejuvenation and Regrowth spells by 4 sec.']),
  ...
  new Item('Book of Command', 'warlock_grimoireofcommand', 'epic', 'Trinket', null, null, null, null, null, ['Use: Increases the damage and critical strike chance of your active pets and summons by 10% for 15 sec. (3 min cooldown)']),
  ...
  new Item(
    ...
    null,
    null,
    { armor: 207, stamina: 0, strength: 0, intellect: 0, spirit: 0, agility: 0 },
