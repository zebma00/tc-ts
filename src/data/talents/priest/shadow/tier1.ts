...
const tier1 = [
  new Talent(
    ...
    [
      'Gives you a ',
      '% chance to gain a 100% bonus to your spirit after killing a target that yields experience or honor. For the duration, your mana will regenerate at a 50% rate while casting. Lasts 15 sec.',
    ],
    3,
    [[33, 67, 100]],
    null,
  ...
  new Talent(
    'Improved Spirit Tap',
    'spell_shadow_requiem',
    ['Gives you a ', '% chance to gain Spirit Tap after dealing Shadow damage.'],
    2,
    [[2, 4]],
    [{ x: 0, y: 0 }],
    null,
...
export default [
	...
	new Talent(
		...
		['Your Shadow spells have a .', '% chance to stun the target for 3 sec.'],
		5,
		[[2, 4, 6, 8, 10]]
	),
	null,
