...
const tier3 = [
  ...
  new Talent('Mana Tap', 'spell_holy_dispelmagic', ['When activated, reduces the mana cost of your next spell by 100%.'], 1, [[]], null, null, null, null, 'Instant', '45 sec cooldown', null, {
    isNew: true,
    isChanged: false,
    isMoved: false,
  }),
