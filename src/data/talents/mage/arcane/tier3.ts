...
const tier3 = [
  ...
  new Talent('Mana Tap', 'spell_frost_manarecharge', ['When activated, reduces the mana cost of your next spell by 100%.'], 1, [[]], null, null, null, null, 'Instant', '1 min cooldown', null, {
    isNew: true,
    isChanged: false,
    isMoved: false,
  }),
