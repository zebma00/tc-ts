...
const tier2 = [
  ...
  new Talent(
    ...
    ['When you cast a damaging spell, your spell damage is increased by ', '% for 30 sec. This effect stacks up to 5 times. This effect is lost when casting the same spell twice in a row.'],
    3,
    [[1, 2, 3]],
    null,
    null,
