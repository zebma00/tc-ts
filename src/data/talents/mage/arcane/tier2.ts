...
const tier2 = [
  ...
  new Talent(
    ...
    ['When you cast a damaging spell, your spell damage is increased by ', '% for 30 sec. This effect stacks up to 5 times. This effect is lost when casting two spells of the same school in a row.'],
    2,
    [[2, 4]],
    null,
    null,
