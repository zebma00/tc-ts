...
const tier5 = [
  new Talent('Burning Determination', 'spell_fire_totemofwrath', ['Reduces the duration of Silence and Interrupt effects on you by ', '%.'], 2, [[25, 50]], null, null, null, null, null, null, null, { isNew: true, isChanged: false, isMoved: false }),
