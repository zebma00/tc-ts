...
const tier3 = [
  ...
  new Talent('Spiritual Attunement', 'spell_holy_revivechampion', ['When you are healed by a friendly target, you gain mana equal to ', '% of the amount healed.'], 2, [[10, 20]], null, null, null, null, null, null, null, {
    isNew: true,
    isChanged: false,
    isMoved: false,
  }),
