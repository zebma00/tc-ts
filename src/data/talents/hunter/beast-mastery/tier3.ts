...
export default [
  ...
  new Talent('Fervor', 'ability_druid_healinginstincts', ['Restore 100 focus to your pet.'], 1, [[]], null, null, 'Instant', '2 min cooldown', null, null, null, { isNew: true, isChanged: false, isMoved: false }),
