...
export default [
  ...
  new Talent('Natural Inspiration', 'spell_nature_windfury', ['Gives you a ', '% chance to increase your agility by 30% for 6 sec after dealing Arcane, Fire or Nature damage.'], 2, [[2, 4]], null, null, null, null, null, null, null, {
    isChanged: false,
    isMoved: false,
    isNew: true,
  }),
