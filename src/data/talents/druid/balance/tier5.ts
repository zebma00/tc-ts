...
const tier5 = [
  new Talent(
    ...
    ['Gives your Starfire hits a ', '% and your Wrath and Moonfire hits a ', '% chance to reduce the cooldown of your Barkskin, Hurricane, Tranquility and Innervate spells by 2 sec.'],
    2,
    [
      [50, 100],
      [25, 50],
