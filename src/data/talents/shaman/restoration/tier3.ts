...
const tier3 = [
  ...
  new Talent("Nature's Focus", 'spell_nature_healingwavelesser', ['Gives you a ', '% chance to avoid interruption caused by damage while casting any Healing spell.'], 5, [[14, 28, 42, 56, 70]]),
  new Talent(
    'Water Shield',
