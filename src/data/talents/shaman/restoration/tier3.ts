...
const tier3 = [
  ...
  new Talent('Totemic Mastery', 'spell_nature_nullward', ['Increases the effect of your totems that affect friendly targets by 100% for 6 sec.'], 1, [[]], null, null, 'Instant', '2 min cooldown', null, null, null, {
    isNew: false,
    isChanged: true,
    isMoved: false,
  }),
