...
const tier2 = [
  ...
  new Talent('Improved Lightning Shield', 'spell_nature_lightningshield', ['Increases the damage of your Lightning orbs by ', '%.'], 2, [[10, 20]], null, null, null, null, null, null, null, { isNew: false, isChanged: true, isMoved: false }),
]
