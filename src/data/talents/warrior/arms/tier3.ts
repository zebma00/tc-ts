...
const tier3 = [
  ...
  new Talent('Weapon Mastery', 'ability_warrior_weaponmastery', ['Your weapon attacks generate 10% more rage. Your critical strikes from weapon attacks generate 20% more rage.'], 1, [[1]], null, null, null, null, null, null, null, {
    isNew: true,
    isChanged: false,
    isMoved: false,
  }),
