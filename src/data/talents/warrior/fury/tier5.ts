...
const tier5 = [
  new Talent(
    ...
    ['Reduces the cost of your Interceot by ', ' rage points. In addition, gives you a ', '% chance to reset the cooldown Intercept after killing a target that yields experience or honor.'],
    2,
    [
      [5, 10],
      [50, 100],
