...
const tier3 = [
	new Talent(
		...
		['Your Slam increases damage dealt by your next Slam by ', '% for 6 sec. This effect stacks up to 5 times.'],
		2,
		[[3, 5]],
		[{ x: 1, y: 0 }],
		null,
	...
	new Talent(
		...
		[
			'Regenerate ',
			'% of your total health over 6 sec after being the victim of a critical strike or dealing a critical strike.',
		],
		3,
		[[1, 2, 3]]
	),
