...
const tier5 = [
  new Talent(
    ...
    ['Reduces the threat generated by your Corruption by ', '%. In addition, the damage of your Corruption is increased by ', '% for each additional active Corruption, up to 200% increased damage.'],
    2,
    [
      [20, 40],
      [10, 20],
