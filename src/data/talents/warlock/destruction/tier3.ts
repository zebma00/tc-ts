...
const tier3 = [
  ...
  new Talent(
    ...
    ['Critical strikes from your damaging spells have a ', '% chance to increase the damage of your next Soul Fire by 10% and increase the cast time by 0.2 sec. This effect stacks up to 10 times.'],
    2,
    [[50, 100]],
    null,
    null,
